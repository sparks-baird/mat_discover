...
<html>
   <body>
   <a href=https://sparks-baird.github.io/mat_discover/figures/pf-train-contrib-proxy.html>
...
<img alt="Pareto Front k-Nearest Neighbor Average Proxy" src=https://sparks-baird.github.io/mat_discover/figures/pf-peak-proxy.png width=350>


#### [Pareto Front Density Proxy (Train and Validation Points)](pf-dens-proxy.html)  
<img alt="Pareto Front Density Proxy (Train and Validation Points)" src=https://sparks-baird.github.io/mat_discover/figures/pf-dens-proxy.png width=350>


### Cluster-Wise
#### [Pareto Front Validation Fraction](pf-frac-proxy.html)  
<img alt="Pareto Front Validation Fraction" src=https://sparks-baird.github.io/mat_discover/figures/pf-frac-proxy.png width=350>


#### [Leave-one-cluster-out Cross-validation k-Nearest Neighbor Average Parity Plot](gcv-pareto.html)  
<img alt="Leave-one-cluster-out Cross-validation k-Nearest Neighbor Average Parity Plot" src=https://sparks-baird.github.io/mat_discover/figures/gcv-pareto.png width=350>
...
<img alt="Cluster Count Histogram" src=https://sparks-baird.github.io/mat_discover/figures/cluster-count-hist.png width=350>

   
[DensMAP Embeddings Colored by Cluster](umap-cluster-scatter.png)  
<img alt="DensMAP Embeddings Colored by Cluster" src=https://sparks-baird.github.io/mat_discover/figures/umap-cluster-scatter.png width=350>

   
### Density and Target Characteristics
[Density Scatter Plot of 2D DensMAP Embeddings](dens-scatter.png)  
<img alt="Density Scatter Plot of 2D DensMAP Embeddings" src=https://sparks-baird.github.io/mat_discover/figures/dens-scatter.png width=350>
   
[Density Scatter Plot with Bulk Modulus Overlay in 2D DensMAP Embedding Space](dens-targ-scatter.png)  
<img alt="Density Scatter Plot with Bulk Modulus Overlay in 2D DensMAP Embedding Space" src=https://sparks-baird.github.io/mat_discover/figures/dens-targ-scatter.png width=350>
