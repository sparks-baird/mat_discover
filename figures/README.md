...
<body>
   <a href=pf-peak-proxy.html>
      <img alt="Pareto Front k-Nearest Neighbor Average Proxy" src=pf-peak-proxy.png width=350>
   </a>
</body>

#### [Pareto Front Density Proxy (Train and Validation Points)](pf-dens-proxy.html)  
<body>
   <a href=pf-dens-proxy.html>
      <img alt="Pareto Front Density Proxy (Train and Validation Points)" src=pf-dens-proxy.png width=350>
</a>

### Cluster-Wise
#### [Pareto Front Validation Fraction](pf-frac-proxy.html)  
<body>
   <a href=pf-frac-proxy.html>
      <img alt="Pareto Front Validation Fraction" src=pf-frac-proxy.png width=350>
   </a>
</body>

#### [Leave-one-cluster-out Cross-validation k-Nearest Neighbor Average Parity Plot](gcv-pareto.html)  
<body>
   <a href=gcv-pareto.html>
      <img alt="Leave-one-cluster-out Cross-validation k-Nearest Neighbor Average Parity Plot" src=gcv-pareto.png width=350>
   </a>
</body>
...
<body>
   <img alt="Cluster Count Histogram" src=cluster-count-hist.png width=350>
</body>
   
DensMAP Embeddings Colored by Cluster  
<body>
   <img alt="DensMAP Embeddings Colored by Cluster" src=umap-cluster-scatter.png width=350>
</body>
   
### Density and Target Characteristics
Density Scatter Plot of 2D DensMAP Embeddings  
<body>
   <img alt="Density Scatter Plot of 2D DensMAP Embeddings" src=dens-scatter.png width=350>
</body>
   
Density Scatter Plot with Bulk Modulus Overlay in 2D DensMAP Embedding Space  
<body>
   <img alt="Density Scatter Plot with Bulk Modulus Overlay in 2D DensMAP Embedding Space" src=dens-targ-scatter.png width=350>
</body>
